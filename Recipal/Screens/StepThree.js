        ...
        <SafeAreaView>
            <ScrollView>
                <View style={styles.overContainer}>
                    ...
                    <View>
                    <Image 
                        source={require('../assets/fish4.jpeg')} 
                    ...
                    />
                        ...
                        <Text style={styles.stepContainer}>Step 4</Text>
                        <Text style={styles.insContainer}>Using a large mortar and pestle pound the coriander, garlic 
                        and chilli together, set it aside.</Text>
                </View>
            </ScrollView>
            <SideMenuButton />
            <BackButton />
