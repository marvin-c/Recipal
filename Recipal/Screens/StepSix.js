        ...
        <SafeAreaView>
            <ScrollView>
                <View style={styles.overContainer}>
                    ...
                    <View>
                    <Image 
                        source={require('../assets/fish7.jpeg')} 
                    ...
                    />
                        ...
                        <Text style={styles.stepContainer}>Step 7</Text>
                        <Text style={styles.insContainer}>Pour the tamarind juice together with the sugar and fish sauce, 
                        simmer in very high heat for two minutes or until the sauce is reduced and is thick.</Text>
                </View>
            </ScrollView>
            <SideMenuButton />
            <BackButton />
