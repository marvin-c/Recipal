        ...
        <SafeAreaView>
            <ScrollView>
                <View style={styles.overContainer}>
                    ...
                    <View>
                    <Image 
                        source={require('../assets/fish2.jpeg')} 
                    ...
                    />
                        ...
                        <Text style={styles.stepContainer}>Step 2</Text>
                        <Text style={styles.insContainer}>Season fish with salt and freshly ground black 
                        pepper then sprinkle flour all over to coat fish.</Text>
                </View>
            </ScrollView>
            <SideMenuButton />
            <BackButton />
